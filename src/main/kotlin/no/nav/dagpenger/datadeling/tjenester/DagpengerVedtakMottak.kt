...
private val sikkerlogg = KotlinLogging.logger("tjenestekall.DagpengerVedtakMottak")

internal class DagpengerVedtakMottak(
    ...
    init {
        River(rapidsConnection)
            .apply {
                ...
                validate {
                    it.requireKey("ident", "behandlingId", "behandletHendelse", "automatisk", "rettighetsperioder")
                }
            }.register(this)
    }
    ...
    override fun onPacket(
        ...
        withLoggingContext(
            ...
            // Her er vi avhengig av at vi får vedtak_fattet_utenfor_arena før behandlingsresultat
